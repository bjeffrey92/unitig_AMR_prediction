...
def fit_best_model(Ab, left_out_cluster, **kwargs):
    ...
    train_pred, train_acc = predict(training_data, model, 
                                    utils.mean_acc_per_bin, adj)
    test_pred, test_acc = predict(testing_data, model, 
                                    utils.mean_acc_per_bin, adj)
    validation_pred, validation_acc = predict(validation_data, model, 
                                            utils.mean_acc_per_bin, adj)
...
if __name__ == '__main__':
    ...
    for left_out_cluster in list(range(1, 13)):
        ...
        best_hyperparams['l2_alpha'] = 10 ** optimizer.max['params']['l2_alpha']
